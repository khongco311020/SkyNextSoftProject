          ...
          <div className={styles.wrapcol}>
            <div className={styles.wrappad}>
              ...
              <p className={styles.wrapp}>
                Khẳng định vị trí tiên phong với vai trò là công ty đầu tiên và  
                lớn nhất chuyên về React trên thị trường.
              </p>
            </div>
          </div>
          <div className={styles.wrapcol}>
        ...
        <div className={styles.achivecontainer}>
          ...
          <div className={styles.achivecol}>
            <div className={styles.achivecontent}>
              ...
              <p>React Plus hoàn thành mục tiêu kép đạt chuẩn ISO 9001:2015 về quản lý chất lượng và ISO 27001:2013 v
                ề quản lý an toàn thông tin trong lĩnh vực Sản xuất và gia công phần mềm do Tổ chức Tiêu chuẩn hóa quốc tế (ISO) chứng nhận.</p>
              <p>Chúng tôi tự hào là đơn vị đầu tiên tại Việt Nam tập trung chuyên sâu về React & React Native, với khả năng cung cấp dịch vụ làm hài lòng mọi khách hàng theo tiêu chuẩn quốc tế</p>
            </div>
          </div>
        </div>
      </div>
